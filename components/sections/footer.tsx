...
export function Footer() {
  return (
    <footer className="bg-[#020205] pt-12 pb-6 border-t border-white/5 relative overflow-hidden">
      {/* Glow on the top edge */}
      <div className="absolute top-0 left-1/2 -translate-x-1/2 w-1/2 h-px bg-gradient-to-r from-transparent via-blue-500/50 to-transparent shadow-[0_0_20px_rgba(59,130,246,0.5)]" />
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 md:gap-8 mb-16">
          ...
          <div className="md:col-span-2">
            ...
            <div className="flex gap-4">
              <a href="#" className="w-10 h-10 rounded-full glass flex items-center justify-center text-white/40 hover:text-white hover:border-white/20 transition-all">
              ...
              <a href="https://instagram.com/dinz.dev" className="w-10 h-10 rounded-full glass flex items-center justify-center text-white/40 hover:text-white hover:border-white/20 transition-all">
          ...
          <div>
            ...
            <ul className="space-y-3">
              {['Services', 'Products', 'Case Studies', 'Tech Stack'].map(link => (
                <li key={link}>
                  <Link href={`#${link.toLowerCase().replace(' ', '-')}`} className="text-white/40 hover:text-white text-sm transition-colors relative group inline-block">
                    {link}
          ...
          <div>
            ...
            <ul className="space-y-3">
              {['About', 'Careers', 'Privacy Policy', 'Terms of Service'].map(link => (
                <li key={link}>
                  <Link href="#" className="text-white/40 hover:text-white text-sm transition-colors relative group inline-block">
                    {link}
                    <span className="absolute bottom-0 left-0 w-0 h-px bg-white transition-all duration-300 group-hover:w-full" />
                  </Link>
                </li>
        ...
        <div className="pt-8 border-t border-white/5 flex flex-col md:flex-row items-center justify-between gap-4">
           <p className="text-white/30 text-xs text-center md:text-left">
             © {new Date().getFullYear()} DINZ. All rights reserved.
           </p>
